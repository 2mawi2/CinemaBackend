...
namespace Mocks
{
    ...
    public class MockServiceProxy : IServiceProxy
    {
        ...
        {
            ServiceInterfaceType = typeof(TServiceInterface);
            return (TServiceInterface)createFunctions[typeof(TServiceInterface)](serviceName);
        }
        ...
        {
            return (TServiceInterface)createFunctions[typeof(TServiceInterface)](serviceUri);
        }

        public void Supports<TServiceInterface>(Func<Uri, object> Create)
        {
            createFunctions[typeof(TServiceInterface)] = Create;
        }
    }
}